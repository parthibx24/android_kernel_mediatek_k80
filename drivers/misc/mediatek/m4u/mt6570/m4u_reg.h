...
#ifndef _MT6570_M4U_REG_H__
#define _MT6570_M4U_REG_H__
...
#define REG_MMU_TABLE_WALK_DIS         0x88
#define REG_MMU_MTLB_RESERVE_MODE_DIS  0x8c
...
#define F_MMU_CTRL_INVLDT_FIFO_EN(en)		F_BIT_VAL(en, 8)
#define F_MMU_CTRL_HANG_PREVENTION_EN(en)		F_BIT_VAL(en, 9)
...
#define F_INT_L2_MISS_FIFO_ERROR                   F_BIT_SET(6)
...
#define F_SMI_DOMN(port, domain)        (((domain)&0xF)<<((port%8)<<4))
