...
UINT32 OV5671_MIPI_RAW_SensorInit(struct SENSOR_FUNCTION_STRUCT **pfFunc);
...
UINT32 S5K4H5YX_2LANE_MIPI_RAW_SensorInit(struct SENSOR_FUNCTION_STRUCT **pfFunc);
...
UINT32 GC2145MIPI_YUV_SensorInit(struct SENSOR_FUNCTION_STRUCT **pfFunc);
...
#endif
#if defined(IMX179_MIPI_RAW_5MP)
	{IMX179_SENSOR_ID, SENSOR_DRVNAME_IMX179_MIPI_RAW_5MP, IMX179_MIPI_RAW_SensorInit},
#endif
#if defined(IMX179_MIPI_RAW_3MP)
	{IMX179_SENSOR_ID, SENSOR_DRVNAME_IMX179_MIPI_RAW_3MP, IMX179_MIPI_RAW_SensorInit},
#endif
...
#endif
#if defined(OV5670_MIPI_RAW_3MP)
	{OV5670MIPI_SENSOR_ID, SENSOR_DRVNAME_OV5670_MIPI_RAW_3MP, OV5670_MIPI_RAW_SensorInit},
#endif
