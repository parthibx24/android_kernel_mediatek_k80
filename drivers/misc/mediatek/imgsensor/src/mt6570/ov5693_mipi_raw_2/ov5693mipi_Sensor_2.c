...
#include "ov5693mipi_Sensor_2.h"

/****************************Modify Following Strings for Debug****************************/
#define PFX "OV5693_camera_sensor"
#define LOG_1 LOG_INF("OV5693_2,MIPI 2LANE\n")
...
static imgsensor_info_struct imgsensor_info = {
    ...
    .pre = {
        ...
        .mipi_data_lp2hs_settle_dc = 75,//unit , ns
...
static void set_mirror_flip(kal_uint8 image_mirror)
{
    ...
    switch (image_mirror) {
        ...
        case IMAGE_H_MIRROR:
            ...
            break;
        case IMAGE_V_MIRROR:
            write_cmos_sensor(0x3820,((read_cmos_sensor(0x3820) & 0xBD) | 0x42));// read_cmos_sensor(0x3820) & 0xBD) | 0x42)   add  by Richard
            write_cmos_sensor(0x3821,((read_cmos_sensor(0x3821) & 0xF9) | 0x00));
            break;
        case IMAGE_HV_MIRROR:
            write_cmos_sensor(0x3820,((read_cmos_sensor(0x3820) & 0xBD) | 0x42));
            write_cmos_sensor(0x3821,((read_cmos_sensor(0x3821) & 0xF9) | 0x06));
            break;
        default:
...
//test
    ...
    while (1) {
            ...
            *sensor_id = return_sensor_id();
            //LOG_INF("xiaotang,Read sensor id , write id: 0x%x, id: 0x%x\n", imgsensor.i2c_write_id,*sensor_id);
            imgsensor.i2c_write_id = imgsensor_info.i2c_addr_table[1];
            *sensor_id = return_sensor_id();
            //LOG_INF("xiaotang,Read sensor id , write id: 0x%x, id: 0x%x\n", imgsensor.i2c_write_id,*sensor_id);
    }
#endif
                      ...
                      MSDK_SENSOR_CONFIG_STRUCT *sensor_config_data)
{
    ...
    spin_unlock(&imgsensor_drv_lock);
    preview_setting();
	set_mirror_flip(IMAGE_H_MIRROR);/*(sensor_config_data->SensorImageMirror);*/
	write_cmos_sensor(0x3820,((read_cmos_sensor(0x3820) & 0xFB) | 0x04));//binning bit[2] should be 1
    return ERROR_NONE;
}    /*    preview   */
                             ...
                             UINT8 *feature_para,UINT32 *feature_para_len)
{
    ...
    switch (feature_id) {
        ...
        case SENSOR_FEATURE_SET_IHDR_SHUTTER_GAIN:
            LOG_INF("SENSOR_SET_SENSOR_IHDR LE=%llu, SE=%llu, Gain=%llu\n",*feature_data,*(feature_data+1),*(feature_data+2));
...
UINT32 OV5693_MIPI_RAW_SensorInit_2(PSENSOR_FUNCTION_STRUCT *pfFunc)
{
