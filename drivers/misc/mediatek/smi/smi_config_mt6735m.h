...
#define SMI_LARB2_PORT_NUM	13	/* IMG */

#define SMI_SCEN_NUM		4	/* init, vpwfd, vr4k, icfp */
#define SMI_ESL_INIT		0
#define SMI_ESL_VPWFD		1
#define SMI_ESL_VR4K		2
#define SMI_ESL_ICFP		3
...
struct mtk_smi_pair smi_larb0_init_pair[SMI_LARB0_PORT_NUM] = {
	...
	{SMI_LARB_OSTDL_PORT(2), 0x4}, {SMI_LARB_OSTDL_PORT(3), 0x6},
...
struct mtk_smi_pair smi_comm_vpwfd_pair[SMI_COMM_SCEN_NUM] = {
	{SMI_L1ARB(0), 0x11ff}, {SMI_L1ARB(1), 0x0}, {SMI_L1ARB(2), 0x1361},
};

struct mtk_smi_pair smi_larb0_vpwfd_pair[SMI_LARB0_PORT_NUM] = {
	{SMI_LARB_OSTDL_PORT(0), 0x8}, {SMI_LARB_OSTDL_PORT(1), 0x8},
	{SMI_LARB_OSTDL_PORT(2), 0x1}, {SMI_LARB_OSTDL_PORT(3), 0x1},
	{SMI_LARB_OSTDL_PORT(4), 0x3}, {SMI_LARB_OSTDL_PORT(5), 0x1},
	{SMI_LARB_OSTDL_PORT(6), 0x4}, {SMI_LARB_OSTDL_PORT(7), 0x1},
};

struct mtk_smi_pair smi_larb1_vpwfd_pair[SMI_LARB1_PORT_NUM] = {
	{SMI_LARB_OSTDL_PORT(0), 0xb}, {SMI_LARB_OSTDL_PORT(1), 0xe},
	{SMI_LARB_OSTDL_PORT(2), 0x1}, {SMI_LARB_OSTDL_PORT(3), 0x1},
	{SMI_LARB_OSTDL_PORT(4), 0x1}, {SMI_LARB_OSTDL_PORT(5), 0x1},
	{SMI_LARB_OSTDL_PORT(6), 0x1},
};

struct mtk_smi_pair smi_larb2_vpwfd_pair[SMI_LARB2_PORT_NUM] = {
...
struct mtk_smi_pair smi_comm_vr4k_pair[SMI_COMM_SCEN_NUM] = {
	{SMI_L1ARB(0), 0x11ff}, {SMI_L1ARB(1), 0x1000}, {SMI_L1ARB(2), 0x1361},
};

struct mtk_smi_pair smi_larb0_vr4k_pair[SMI_LARB0_PORT_NUM] = {
	{SMI_LARB_OSTDL_PORT(0), 0x6}, {SMI_LARB_OSTDL_PORT(1), 0x6},
	{SMI_LARB_OSTDL_PORT(2), 0x1}, {SMI_LARB_OSTDL_PORT(3), 0x1},
	{SMI_LARB_OSTDL_PORT(4), 0x1}, {SMI_LARB_OSTDL_PORT(5), 0x1},
	{SMI_LARB_OSTDL_PORT(6), 0x1}, {SMI_LARB_OSTDL_PORT(7), 0x1},
};
...
struct mtk_smi_pair smi_comm_icfp_pair[SMI_COMM_SCEN_NUM] = {
	{SMI_L1ARB(0), 0x11da}, {SMI_L1ARB(1), 0x1000}, {SMI_L1ARB(2), 0x1318},
};
...
struct mtk_smi_pair *smi_larb2_scen_pair[SMI_SCEN_NUM] = {
	smi_larb2_init_pair, smi_larb2_vpwfd_pair, smi_larb2_vpwfd_pair,
	smi_larb2_vpwfd_pair,
};
...
struct mtk_smi_pair smi_comm_config_pair[SMI_COMM_CONFIG_NUM] = {
	{SMI_L1LEN, 0xb}, {SMI_READ_FIFO_TH, 0x747}, {SMI_M4U_TH, 0xf7e19085},
	{SMI_DUMMY, 0x1},
};

#define SMI_LARB_CONFIG_NUM	2
struct mtk_smi_pair smi_larb0_config_pair[SMI_LARB_CONFIG_NUM] = {
	{SMI_LARB_VC_PRI_MODE, 0x0}, {SMI_LARB_SW_FLAG, 0x1},
};

struct mtk_smi_pair smi_larb1_config_pair[SMI_LARB_CONFIG_NUM] = {
	{SMI_LARB_VC_PRI_MODE, 0x2}, {SMI_LARB_SW_FLAG, 0x1},
};

struct mtk_smi_pair smi_larb2_config_pair[SMI_LARB_CONFIG_NUM] = {
	{SMI_LARB_VC_PRI_MODE, 0x1}, {SMI_LARB_SW_FLAG, 0x1},
};

unsigned int smi_config_pair_num[SMI_LARB_NUM + 1] = {
	SMI_LARB_CONFIG_NUM, SMI_LARB_CONFIG_NUM, SMI_LARB_CONFIG_NUM,
	SMI_COMM_CONFIG_NUM,
};
