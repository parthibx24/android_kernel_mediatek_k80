...
#define SMI_LARB0_PORT_NUM	7	/* MMSYS */
#define SMI_LARB0_PORT_NUM	11	/* IMGSYS */

#define SMI_SCEN_NUM		3	/* init, vpwfd, vr4k */
...
struct mtk_smi_pair smi_comm_init_pair[SMI_COMM_SCEN_NUM] = {
	{SMI_L1ARB(0), 0x14cb}, {SMI_L1ARB(1), 0x1001}
};

struct mtk_smi_pair smi_larb0_init_pair[SMI_LARB0_PORT_NUM] = {
	{SMI_LARB_OSTDL_PORT(0), 0x1c}, {SMI_LARB_OSTDL_PORT(1), 0x4},
	{SMI_LARB_OSTDL_PORT(2), 0x6}, {SMI_LARB_OSTDL_PORT(3), 0x1},
...
struct mtk_smi_pair smi_comm_vpwfd_pair[SMI_COMM_SCEN_NUM] = {
	{SMI_L1ARB(0), 0x11ff}, {SMI_L1ARB(1), 0x0}
};

struct mtk_smi_pair smi_larb0_vpwfd_pair[SMI_LARB0_PORT_NUM] = {
	{SMI_LARB_OSTDL_PORT(0), 0x8}, {SMI_LARB_OSTDL_PORT(1), 0x1},
	{SMI_LARB_OSTDL_PORT(2), 0x1}, {SMI_LARB_OSTDL_PORT(3), 0x3},
	{SMI_LARB_OSTDL_PORT(4), 0x1}, {SMI_LARB_OSTDL_PORT(5), 0x4},
	{SMI_LARB_OSTDL_PORT(6), 0x1}
};

struct mtk_smi_pair smi_larb1_vpwfd_pair[SMI_LARB1_PORT_NUM] = {
	{SMI_LARB_OSTDL_PORT(0), 0x8}, {SMI_LARB_OSTDL_PORT(1), 0x6},
	{SMI_LARB_OSTDL_PORT(2), 0x1}, {SMI_LARB_OSTDL_PORT(3), 0x1},
	{SMI_LARB_OSTDL_PORT(4), 0x4}, {SMI_LARB_OSTDL_PORT(5), 0x1},
	{SMI_LARB_OSTDL_PORT(6), 0x1}, {SMI_LARB_OSTDL_PORT(7), 0x1},
	{SMI_LARB_OSTDL_PORT(8), 0x3}, {SMI_LARB_OSTDL_PORT(9), 0x2},
	{SMI_LARB_OSTDL_PORT(10), 0x2}
};

/* scen: vr4k */
struct mtk_smi_pair smi_comm_vr4k_pair[SMI_COMM_SCEN_NUM] = {
	{SMI_L1ARB(0), 0x122b}, {SMI_L1ARB(1), 0x142c}
};

struct mtk_smi_pair smi_larb0_vr4k_pair[SMI_LARB0_PORT_NUM] = {
	{SMI_LARB_OSTDL_PORT(0), 0xa}, {SMI_LARB_OSTDL_PORT(1), 0x1},
	{SMI_LARB_OSTDL_PORT(2), 0x1}, {SMI_LARB_OSTDL_PORT(3), 0x4},
	{SMI_LARB_OSTDL_PORT(4), 0x2}, {SMI_LARB_OSTDL_PORT(5), 0x2},
	{SMI_LARB_OSTDL_PORT(6), 0x1}
};

struct mtk_smi_pair smi_larb1_vr4k_pair[SMI_LARB1_PORT_NUM] = {
	{SMI_LARB_OSTDL_PORT(0), 0x8}, {SMI_LARB_OSTDL_PORT(1), 0x6},
	{SMI_LARB_OSTDL_PORT(2), 0x1}, {SMI_LARB_OSTDL_PORT(3), 0x1},
	{SMI_LARB_OSTDL_PORT(4), 0x4}, {SMI_LARB_OSTDL_PORT(5), 0x1},
	{SMI_LARB_OSTDL_PORT(6), 0x1}, {SMI_LARB_OSTDL_PORT(7), 0x1},
...
unsigned int smi_scen_pair_num[SMI_LARB_NUM + 1] = {
	SMI_LARB0_PORT_NUM, SMI_LARB1_PORT_NUM, SMI_COMM_SCEN_NUM
};

struct mtk_smi_pair *smi_comm_scen_pair[SMI_SCEN_NUM] = {
	smi_comm_init_pair, smi_comm_vpwfd_pair, smi_comm_vr4k_pair
};

struct mtk_smi_pair *smi_larb0_scen_pair[SMI_SCEN_NUM] = {
	smi_larb0_init_pair, smi_larb0_vpwfd_pair, smi_larb0_vr4k_pair
};

struct mtk_smi_pair *smi_larb1_scen_pair[SMI_SCEN_NUM] = {
	smi_larb1_init_pair, smi_larb1_vpwfd_pair, smi_larb1_vr4k_pair
};

struct mtk_smi_pair **smi_scen_pair[SMI_LARB_NUM + 1] = {
	smi_larb0_scen_pair, smi_larb1_scen_pair, smi_comm_scen_pair
};

/* config */
#define SMI_COMM_CONFIG_NUM	4
struct mtk_smi_pair smi_comm_config_pair[SMI_COMM_CONFIG_NUM] = {
	{SMI_L1LEN, 0xb}, {SMI_READ_FIFO_TH, 0x3a3}, {SMI_M4U_TH, 0xf7e19085},
	{SMI_DUMMY, 0x1}
};

#define SMI_LARB0_CONFIG_NUM	2
struct mtk_smi_pair smi_larb0_config_pair[SMI_LARB0_CONFIG_NUM] = {
	{SMI_LARB_VC_PRI_MODE, 0x0}, {SMI_LARB_SW_FLAG, 0x1}
};

#define SMI_LARB1_CONFIG_NUM	2
struct mtk_smi_pair smi_larb1_config_pair[SMI_LARB1_CONFIG_NUM] = {
	{SMI_LARB_VC_PRI_MODE, 0x2}, {SMI_LARB_SW_FLAG, 0x1}
};

unsigned int smi_config_pair_num[SMI_LARB_NUM + 1] = {
	SMI_LARB0_CONFIG_NUM, SMI_LARB1_CONFIG_NUM, SMI_COMM_CONFIG_NUM
};

struct mtk_smi_pair *smi_config_pair[SMI_LARB_NUM + 1] = {
	smi_larb0_config_pair, smi_larb1_config_pair, smi_comm_config_pair
};
