...
{
	struct lhd_limit_data core_to_set, freq_to_set;
	...
	lhd_update_userlimit_cpu_core(LHD_KIR_PERF_KERN, 1, &core_to_set);
	lhd_update_userlimit_cpu_freq(LHD_KIR_PERF_KERN, 1, &freq_to_set);
}
