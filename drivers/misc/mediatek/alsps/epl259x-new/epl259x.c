...
#endif
#endif /*ANDR_M*/
#if 0 //CONFIG_PM_SLEEP
static const struct dev_pm_ops epl259_pm_ops = {
...
static int als_dynamic_intt_low_thr[] = {200, 6000};
...
static void initial_global_variable(struct i2c_client *client, struct epl_sensor_priv *obj)
{
    ...
    epl_sensor.als.report_type = CMC_BIT_RAW; //CMC_BIT_RAW; //CMC_BIT_DYN_INT;
