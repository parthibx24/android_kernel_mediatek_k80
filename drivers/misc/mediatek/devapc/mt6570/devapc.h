...
#define DEVAPC0_MM_SEC_0            ((unsigned int *)(devapc_ao_base+0x0E00))
#define DEVAPC0_MM_SEC_1            ((unsigned int *)(devapc_ao_base+0x0E04))
...
#define DEVAPC0_PD_APC_LOCK_0       ((unsigned int *)(devapc_ao_base+0x0F04))
#define DEVAPC0_PD_APC_LOCK_1       ((unsigned int *)(devapc_ao_base+0x0F08))
#define DEVAPC0_PD_APC_LOCK_2       ((unsigned int *)(devapc_ao_base+0x0F0C))
#define DEVAPC0_PD_APC_LOCK_3       ((unsigned int *)(devapc_ao_base+0x0F10))
#define DEVAPC0_PD_APC_LOCK_4       ((unsigned int *)(devapc_ao_base+0x0F14))
