 ...
 *************************************************/
/* CAM_CTL_INT_STATUS */
#define ISP_IRQ_INT_STATUS_VS1_ST               (1U << 0)
#define ISP_IRQ_INT_STATUS_TG1_ST1              (1U << 1)
#define ISP_IRQ_INT_STATUS_TG1_ST2              (1U << 2)
#define ISP_IRQ_INT_STATUS_EXPDON1_ST           (1U << 3)
#define ISP_IRQ_INT_STATUS_TG1_ERR_ST           (1U << 4)
#define ISP_IRQ_INT_STATUS_PASS1_TG1_DON_ST     (1U << 10)
#define ISP_IRQ_INT_STATUS_SOF1_INT_ST          (1U << 12)
#define ISP_IRQ_INT_STATUS_CQ_ERR_ST            (1U << 13)
#define ISP_IRQ_INT_STATUS_PASS2_DON_ST         (1U << 14)
#define ISP_IRQ_INT_STATUS_TPIPE_DON_ST         (1U << 15)
#define ISP_IRQ_INT_STATUS_AF_DON_ST            (1U << 16)
#define ISP_IRQ_INT_STATUS_FLK_DON_ST           (1U << 17)
#define ISP_IRQ_INT_STATUS_CQ_DON_ST            (1U << 19)
#define ISP_IRQ_INT_STATUS_IMGO_ERR_ST          (1U << 20)
#define ISP_IRQ_INT_STATUS_AAO_ERR_ST           (1U << 21)
#define ISP_IRQ_INT_STATUS_IMG2O_ERR_ST         (1U << 23)
#define ISP_IRQ_INT_STATUS_ESFKO_ERR_ST         (1U << 24)
#define ISP_IRQ_INT_STATUS_FLK_ERR_ST           (1U << 25)
#define ISP_IRQ_INT_STATUS_LSC_ERR_ST           (1U << 26)
#define ISP_IRQ_INT_STATUS_FBC_IMGO_DONE_ST     (1U << 28)
#define ISP_IRQ_INT_STATUS_DMA_ERR_ST           (1U << 30)
/* CAM_CTL_DMA_INT */
#define ISP_IRQ_DMA_INT_IMGO_DONE_ST            (1U << 0)
#define ISP_IRQ_DMA_INT_IMG2O_DONE_ST           (1U << 1)
#define ISP_IRQ_DMA_INT_AAO_DONE_ST             (1U << 2)
/* #define ISP_IRQ_DMA_INT_LCSO_DONE_ST            ((unsigned int)1 << 3) */
#define ISP_IRQ_DMA_INT_ESFKO_DONE_ST           (1U << 4)
...
#define ISP_IRQ_DMA_INT_CQ0_ERR_ST              (1U << 8)
#define ISP_IRQ_DMA_INT_CQ0_DONE_ST             (1U << 9)
/* #define ISP_IRQ_DMA_INT_SOF2_INT_ST             ((unsigned int)1 << 10) */
/* #define ISP_IRQ_DMA_INT_BUF_OVL_ST              ((unsigned int)1 << 11) */
#define ISP_IRQ_DMA_INT_TG1_GBERR_ST            (1U << 12)
/* #define ISP_IRQ_DMA_INT_TG2_GBERR_ST            ((unsigned int)1 << 13) */
#define ISP_IRQ_DMA_INT_CQ0C_DONE_ST            (1U << 14)
#define ISP_IRQ_DMA_INT_CQ0B_DONE_ST            (1U << 15)
/* CAM_CTL_INTB_STATUS */
#define ISP_IRQ_INTB_STATUS_CQ_ERR_ST           (1U << 13)
#define ISP_IRQ_INTB_STATUS_PASS2_DON_ST        (1U << 14)
#define ISP_IRQ_INTB_STATUS_TPIPE_DON_ST        (1U << 15)
#define ISP_IRQ_INTB_STATUS_CQ_DON_ST           (1U << 19)
#define ISP_IRQ_INTB_STATUS_IMGO_ERR_ST         (1U << 20)
#define ISP_IRQ_INTB_STATUS_LCSO_ERR_ST         (1U << 22)
#define ISP_IRQ_INTB_STATUS_IMG2O_ERR_ST        (1U << 23)
#define ISP_IRQ_INTB_STATUS_LSC_ERR_ST          (1U << 26)
#define ISP_IRQ_INTB_STATUS_BPC_ERR_ST          (1U << 28)
#define ISP_IRQ_INTB_STATUS_LCE_ERR_ST          (1U << 29)
#define ISP_IRQ_INTB_STATUS_DMA_ERR_ST          (1U << 30)
#define ISP_IRQ_INTB_STATUS_INT_WCLR_ST         (1U << 31)

/* CAM_CTL_DMAB_INT */
#define ISP_IRQ_DMAB_INT_IMGO_DONE_ST           (1U << 0)
#define ISP_IRQ_DMAB_INT_IMG2O_DONE_ST          (1U << 1)
#define ISP_IRQ_DMAB_INT_AAO_DONE_ST            (1U << 2)
#define ISP_IRQ_DMAB_INT_LCSO_DONE_ST           (1U << 3)
#define ISP_IRQ_DMAB_INT_ESFKO_DONE_ST          (1U << 4)
#define ISP_IRQ_DMAB_INT_DISPO_DONE_ST          (1U << 5)
#define ISP_IRQ_DMAB_INT_VIDO_DONE_ST           (1U << 6)
...
/* CAM_CTL_INTC_STATUS */
#define ISP_IRQ_INTC_STATUS_CQ_ERR_ST           (1U << 13)
#define ISP_IRQ_INTC_STATUS_PASS2_DON_ST        (1U << 14)
#define ISP_IRQ_INTC_STATUS_TPIPE_DON_ST        (1U << 15)
#define ISP_IRQ_INTC_STATUS_CQ_DON_ST           (1U << 19)
#define ISP_IRQ_INTC_STATUS_IMGO_ERR_ST         (1U << 20)
#define ISP_IRQ_INTC_STATUS_LCSO_ERR_ST         (1U << 22)
#define ISP_IRQ_INTC_STATUS_IMG2O_ERR_ST        (1U << 23)
#define ISP_IRQ_INTC_STATUS_LSC_ERR_ST          (1U << 26)
#define ISP_IRQ_INTC_STATUS_BPC_ERR_ST          (1U << 28)
#define ISP_IRQ_INTC_STATUS_LCE_ERR_ST          (1U << 29)
#define ISP_IRQ_INTC_STATUS_DMA_ERR_ST          (1U << 30)
/* CAM_CTL_DMAC_INT */
#define ISP_IRQ_DMAC_INT_IMGO_DONE_ST           (1U << 0)
#define ISP_IRQ_DMAC_INT_IMG2O_DONE_ST          (1U << 1)
#define ISP_IRQ_DMAC_INT_AAO_DONE_ST            (1U << 2)
#define ISP_IRQ_DMAC_INT_LCSO_DONE_ST           (1U << 3)
#define ISP_IRQ_DMAC_INT_ESFKO_DONE_ST          (1U << 4)
#define ISP_IRQ_DMAC_INT_DISPO_DONE_ST          (1U << 5)
#define ISP_IRQ_DMAC_INT_VIDO_DONE_ST           (1U << 6)
...
/* CAM_CTL_INT_STATUSX */
#define ISP_IRQ_INTX_STATUS_VS1_ST              (1U << 0)
#define ISP_IRQ_INTX_STATUS_TG1_ST1             (1U << 1)
#define ISP_IRQ_INTX_STATUS_TG1_ST2             (1U << 2)
#define ISP_IRQ_INTX_STATUS_EXPDON1_ST          (1U << 3)
#define ISP_IRQ_INTX_STATUS_TG1_ERR_ST          (1U << 4)
#define ISP_IRQ_INTX_STATUS_VS2_ST              (1U << 5)
#define ISP_IRQ_INTX_STATUS_TG2_ST1             (1U << 6)
#define ISP_IRQ_INTX_STATUS_TG2_ST2             (1U << 7)
#define ISP_IRQ_INTX_STATUS_EXPDON2_ST          (1U << 8)
#define ISP_IRQ_INTX_STATUS_TG2_ERR_ST          (1U << 9)
#define ISP_IRQ_INTX_STATUS_PASS1_TG1_DON_ST    (1U << 10)
#define ISP_IRQ_INTX_STATUS_PASS1_TG2_DON_ST    (1U << 11)
/* #define ISP_IRQ_INTX_STATUS_VEC_DON_ST          ((unsigned int)1 << 12) */
#define ISP_IRQ_INTX_STATUS_CQ_ERR_ST           (1U << 13)
#define ISP_IRQ_INTX_STATUS_PASS2_DON_ST        (1U << 14)
#define ISP_IRQ_INTX_STATUS_TPIPE_DON_ST        (1U << 15)
#define ISP_IRQ_INTX_STATUS_AF_DON_ST           (1U << 16)
#define ISP_IRQ_INTX_STATUS_FLK_DON_ST          (1U << 17)
#define ISP_IRQ_INTX_STATUS_FMT_DON_ST          (1U << 18)
#define ISP_IRQ_INTX_STATUS_CQ_DON_ST           (1U << 19)
#define ISP_IRQ_INTX_STATUS_IMGO_ERR_ST         (1U << 20)
#define ISP_IRQ_INTX_STATUS_AAO_ERR_ST          (1U << 21)
#define ISP_IRQ_INTX_STATUS_LCSO_ERR_ST         (1U << 22)
#define ISP_IRQ_INTX_STATUS_IMG2O_ERR_ST        (1U << 23)
#define ISP_IRQ_INTX_STATUS_ESFKO_ERR_ST        (1U << 24)
#define ISP_IRQ_INTX_STATUS_FLK_ERR_ST          (1U << 25)
#define ISP_IRQ_INTX_STATUS_LSC_ERR_ST          (1U << 26)
/* #define ISP_IRQ_INTX_STATUS_LSC2_ERR_ST         ((unsigned int)1 << 27) */
#define ISP_IRQ_INTX_STATUS_BPC_ERR_ST          (1U << 28)
#define ISP_IRQ_INTX_STATUS_LCE_ERR_ST          (1U << 29)
#define ISP_IRQ_INTX_STATUS_DMA_ERR_ST          (1U << 30)
/* CAM_CTL_DMA_INTX */
#define ISP_IRQ_DMAX_INT_IMGO_DONE_ST           (1U << 0)
#define ISP_IRQ_DMAX_INT_IMG2O_DONE_ST          (1U << 1)
#define ISP_IRQ_DMAX_INT_AAO_DONE_ST            (1U << 2)
#define ISP_IRQ_DMAX_INT_LCSO_DONE_ST           (1U << 3)
#define ISP_IRQ_DMAX_INT_ESFKO_DONE_ST          (1U << 4)
#define ISP_IRQ_DMAX_INT_DISPO_DONE_ST          (1U << 5)
#define ISP_IRQ_DMAX_INT_VIDO_DONE_ST           (1U << 6)
#define ISP_IRQ_DMAX_INT_VRZO_DONE_ST           (1U << 7)
#define ISP_IRQ_DMAX_INT_NR3O_DONE_ST           (1U << 8)
#define ISP_IRQ_DMAX_INT_NR3O_ERR_ST            (1U << 9)
#define ISP_IRQ_DMAX_INT_CQ_ERR_ST              (1U << 10)
#define ISP_IRQ_DMAX_INT_BUF_OVL_ST             (1U << 11)
#define ISP_IRQ_DMAX_INT_TG1_GBERR_ST           (1U << 12)
#define ISP_IRQ_DMAX_INT_TG2_GBERR_ST           (1U << 13)
...
ISP_CMD_READ_REG, struct ISP_REG_IO_STRUCT)
#define ISP_WRITE_REGISTER  _IOWR(ISP_MAGIC, \
ISP_CMD_WRITE_REG, struct ISP_REG_IO_STRUCT)
#define ISP_HOLD_REG_TIME   _IOW(ISP_MAGIC, \
ISP_CMD_HOLD_TIME, enum ISP_HOLD_TIME_ENUM)
#define ISP_HOLD_REG        _IOW(ISP_MAGIC, \
ISP_CMD_HOLD_REG,      bool)
#define ISP_WAIT_IRQ        _IOW(ISP_MAGIC, \
ISP_CMD_WAIT_IRQ, struct ISP_WAIT_IRQ_STRUCT)
#define ISP_READ_IRQ        _IOR(ISP_MAGIC, \
ISP_CMD_READ_IRQ, struct ISP_READ_IRQ_STRUCT)
#define ISP_CLEAR_IRQ       _IOW(ISP_MAGIC, \
ISP_CMD_CLEAR_IRQ, struct ISP_CLEAR_IRQ_STRUCT)
...
ISP_CMD_RT_BUF_CTRL, struct ISP_BUFFER_CTRL_STRUCT)
#define ISP_REF_CNT_CTRL    _IOWR(ISP_MAGIC, \
ISP_CMD_REF_CNT, struct ISP_REF_CNT_CTRL_STRUCT)
#define ISP_DEBUG_FLAG      _IOW(ISP_MAGIC, \
ISP_CMD_DEBUG_FLAG,    unsigned long)
#define ISP_WAKELOCK_CTRL   _IOWR(ISP_MAGIC, \
ISP_CMD_WAKELOCK_CTRL, unsigned long)
#define ISP_SENSOR_FREQ_CTRL  _IOW(ISP_MAGIC, \
ISP_CMD_SENSOR_FREQ_CTRL,    unsigned long)

#ifdef CONFIG_COMPAT
#define COMPAT_ISP_READ_REGISTER   _IOWR(ISP_MAGIC, \
ISP_CMD_READ_REG, struct compat_ISP_REG_IO_STRUCT)
#define COMPAT_ISP_WRITE_REGISTER  _IOWR(ISP_MAGIC, \
ISP_CMD_WRITE_REG, struct compat_ISP_REG_IO_STRUCT)
#define COMPAT_ISP_BUFFER_CTRL     _IOWR(ISP_MAGIC, \
ISP_CMD_RT_BUF_CTRL, struct compat_ISP_BUFFER_CTRL_STRUCT)
#define COMPAT_ISP_REF_CNT_CTRL    _IOWR(ISP_MAGIC, \
ISP_CMD_REF_CNT, struct compat_ISP_REF_CNT_CTRL_STRUCT)
#define COMPAT_ISP_SET_USER_PID    _IOW(ISP_MAGIC, \
ISP_CMD_SET_USER_PID,  compat_uptr_t)
#define COMPAT_ISP_DEBUG_FLAG      _IOW(ISP_MAGIC, \
ISP_CMD_DEBUG_FLAG,    compat_uptr_t)
#define COMPAT_ISP_WAKELOCK_CTRL   _IOWR(ISP_MAGIC, \
ISP_CMD_WAKELOCK_CTRL, compat_uptr_t)
#define COMPAT_ISP_SENSOR_FREQ_CTRL _IOW(ISP_MAGIC, \
ISP_CMD_SENSOR_FREQ_CTRL, compat_uptr_t)
#endif
