...
typedef enum _ENUM_PARAM_PHY_CONFIG_T {
	PHY_CONFIG_802_11ABG = 0,	/*!< Can associated with 802.11abg AP but without n capability, Scan dual band.
					 **/
	PHY_CONFIG_802_11BG,	/*
				 * !< Can associated with 802_11bg AP, Scan single band and not report 5G BSSs.
				 */
	PHY_CONFIG_802_11G,	/*
				 * !< Can associated with 802_11g only AP, Scan single band and not report 5G
				 * BSSs.
				 */
	PHY_CONFIG_802_11A,	/*
				 * !< Can associated with 802_11a only AP, Scan single band and not report 2.4G
				 * BSSs.
				 */
	PHY_CONFIG_802_11B,	/*
				 * !< Can associated with 802_11b only AP, Scan single band and not report 5G
				 * BSSs.
				 */
	...
	PHY_CONFIG_802_11BGN,	/*!< Can associated with 802_11bgn AP, Scan single band and not report 5G BSSs.
				 **/
	PHY_CONFIG_802_11AN,	/*
				 * !< Can associated with 802_11an AP, Scan single band and not report 2.4G BSSs.
				 */
	PHY_CONFIG_802_11GN,	/*
				 * !< Can associated with 802_11gn AP, Scan single band and not report 5G BSSs.
				 */
	PHY_CONFIG_802_11AC,
