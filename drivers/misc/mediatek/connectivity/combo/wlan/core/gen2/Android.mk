...
ifneq ($(filter "CONSYS_6797" "CONSYS_6759" "CONSYS_6758",$(MTK_COMBO_CHIP)),)
#GEN3 ignored
else ifneq ($(filter CONSYS_%,$(MTK_COMBO_CHIP)),)
$(warning $(MTK_COMBO_CHIP) gen2 wlan driver (wlan_drv.ko))

include $(CLEAR_VARS)
LOCAL_MODULE := wlan_drv.ko
...
$(LOCAL_BUILT_MODULE): $(LOCAL_GENERATED_SOURCES) $(KERNEL_ZIMAGE_OUT) $(LOCAL_EXPORT_SYMBOL) $(AUTO_CONF) $(AUTOCONF_H)
	@echo $@: $^
