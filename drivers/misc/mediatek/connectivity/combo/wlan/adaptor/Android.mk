...
ifeq ($(KERNEL_OUT),)
    ...
    $(warning KERNEL_OUT defined: $(KERNEL_OUT))
endif
...
LOCAL_INIT_RC := init.wmt_chrdev_wifi.rc
...
WMT_CHRDEV_WIFI_EXPORT_SYMBOL := $(intermediates)/Module.symvers
$(WMT_CHRDEV_WIFI_EXPORT_SYMBOL).in: $(intermediates)/% : $(WMT_EXPORT_SYMBOL)
	$(copy-file-to-target)
...
$(LOCAL_BUILT_MODULE): $(LOCAL_GENERATED_SOURCES) $(KERNEL_ZIMAGE_OUT) $(WMT_CHRDEV_WIFI_EXPORT_SYMBOL).in $(AUTO_CONF) $(AUTOCONF_H)
	@echo $@: $^
