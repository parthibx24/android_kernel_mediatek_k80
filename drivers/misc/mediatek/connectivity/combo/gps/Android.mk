...
GPS_EXPORT_SYMBOL := $(intermediates)/Module.symvers
$(GPS_EXPORT_SYMBOL).in: $(intermediates)/% : $(WMT_EXPORT_SYMBOL)
	$(copy-file-to-target)
	cp $(WMT_EXPORT_SYMBOL) $(GPS_EXPORT_SYMBOL)
...
$(LOCAL_BUILT_MODULE): $(LOCAL_GENERATED_SOURCES) $(KERNEL_ZIMAGE_OUT) $(GPS_EXPORT_SYMBOL).in $(AUTO_CONF) $(AUTOCONF_H)
	@echo $@: $^
