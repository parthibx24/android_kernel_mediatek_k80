...
FMRADIO_EXPORT_SYMBOL := $(intermediates)/Module.symvers
$(FMRADIO_EXPORT_SYMBOL).in: $(intermediates)/% : $(WMT_EXPORT_SYMBOL)
	$(copy-file-to-target)
...
$(LOCAL_BUILT_MODULE): $(LOCAL_GENERATED_SOURCES) $(KERNEL_ZIMAGE_OUT) $(FMRADIO_EXPORT_SYMBOL).in $(AUTO_CONF) $(AUTOCONF_H)
	@echo $@: $^
