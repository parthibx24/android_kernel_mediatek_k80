...
int ovl_build_cmdq(DISP_MODULE_ENUM module, void *cmdq_trigger_handle, enum CMDQ_STATE state)
{
	int ret = 0;
...
static int ovl_io(DISP_MODULE_ENUM module, unsigned int msg, unsigned long arg, void *cmdq)
{
	int ret = 0;
