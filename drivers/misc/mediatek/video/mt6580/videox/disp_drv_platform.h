...
#define PRIMARY_DISPLAY_SESSION_LAYER_COUNT	((PRIMARY_DISPLAY_HW_OVERLAY_LAYER_NUMBER - 1) *	\
							PRIMARY_DISPLAY_HW_OVERLAY_CASCADE_COUNT)
#define EXTERNAL_DISPLAY_SESSION_LAYER_COUNT	((PRIMARY_DISPLAY_HW_OVERLAY_LAYER_NUMBER - 1) *	\
							PRIMARY_DISPLAY_HW_OVERLAY_CASCADE_COUNT)
#else
