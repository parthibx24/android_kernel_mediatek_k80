...
char *ddp_get_fmt_name(DISP_MODULE_ENUM module, unsigned int fmt)
{
	if (module == DISP_MODULE_WDMA0) {
		...
		case 12:
			return "nv12";
		default:
			DISPERR("ddp_get_fmt_name, unknown fmt=%d, module=%d\n", fmt, module);
			return "unknown";
		}
...
int ddp_dump_reg(DISP_MODULE_ENUM module)
{
	...
	case DISP_MODULE_DITHER:
		...
		break;
	default:
		DISPERR("DDP error, dump_reg unknown module=%d\n", module);
	}
	return 0;
}
...
int ddp_dump_analysis(DISP_MODULE_ENUM module)
{
	...
	case DISP_MODULE_DITHER:
		...
		break;
	default:
		DISPERR("DDP error, dump_analysis unknown module=%d\n", module);
	}
	return 0;
}
