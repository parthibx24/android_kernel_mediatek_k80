...
/* start module */
int rdma_start(enum enum DISP_MODULE_ENUM module, void *handle);

/* stop module */
int rdma_stop(enum enum DISP_MODULE_ENUM module, void *handle);

/* reset module */
int rdma_reset(enum enum DISP_MODULE_ENUM module, void *handle);
...
void rdma_get_address(enum enum DISP_MODULE_ENUM module, unsigned long *data);
void rdma_dump_reg(enum enum DISP_MODULE_ENUM module);
void rdma_dump_analysis(enum enum DISP_MODULE_ENUM module);
