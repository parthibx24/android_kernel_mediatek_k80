...
static int trusty_virtio_probe(struct platform_device *pdev)
{
	...
	TEEI_BOOT_FOOTPRINT("TEEI Virtio Probe Start");
	...
	TEEI_BOOT_FOOTPRINT("TEEI Virtio Add Device");
	...
	TEEI_BOOT_FOOTPRINT("TEEI Virtio Probe End");
...
static int trusty_virtio_remove(struct platform_device *pdev)
{
	...
	TEEI_BOOT_FOOTPRINT("TEEI Virtio Remove Start");
	...
	TEEI_BOOT_FOOTPRINT("TEEI Virtio Remove End");
