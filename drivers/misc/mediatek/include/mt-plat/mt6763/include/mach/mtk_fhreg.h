...
#define REG_ARMPLL3_CON0    REG_PLL_NOT_SUPPORT /* not support in mt6763 */
#define REG_CCIPLL_CON0     REG_APMIX_ADDR(0x0290)
#define REG_GPUPLL_CON0     REG_APMIX_ADDR(0x0240) /* change name to MFGPLL in mt6763*/
...
#define REG_VDECPLL_CON0    REG_PLL_NOT_SUPPORT /* not support in mt6763 */
...
#define REG_ARMPLL3_CON1    REG_PLL_NOT_SUPPORT /* not support in mt6763 */
#define REG_CCIPLL_CON1     REG_APMIX_ADDR(0x0294)
#define REG_GPUPLL_CON1     REG_APMIX_ADDR(0x0244) /* change name to MFGPLL in mt6763*/
...
#define REG_VDECPLL_CON1    REG_PLL_NOT_SUPPORT /* not support in mt6763 */
