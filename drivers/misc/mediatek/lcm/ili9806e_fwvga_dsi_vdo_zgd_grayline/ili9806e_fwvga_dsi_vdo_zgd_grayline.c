...
/* Local Constants */
#define LCM_NAME "ili9806e_fwvga_dsi_vdo_zgd_grayline"
#define LCM_VERSION "20.1104" /* YEAR+"."+MONTH+DATE */
...
struct LCM_DRIVER ili9806e_fwvga_dsi_vdo_zgd_grayline_lcm_drv =
{
    .name           = LCM_NAME,
