...
static int __match_id(u32 axi_id, int tbl_idx, u32 port_ID, u32 read_vio)
{
	...
	if (((axi_id & mst_tbl[tbl_idx].id_mask) == mst_tbl[tbl_idx].id_val) &&
		...
		case MONITOR_PORT_MDMCU:
		case MONITOR_PORT_MDHW:
...
static ssize_t emi_mpu_show(struct device_driver *driver, char *buf)
{
	...
	lock = (reg_value >> 15) & 0x1;
	d0 = (reg_value & 0x7);
	d1 = (reg_value >> 3) & 0x7;
	d2 = (reg_value >> 6) & 0x7;
	d3 = (reg_value >> 9) & 0x7;
	ptr += sprintf(ptr,
		       "Region 0 (%s) --> d0 = %s, d1 = %s, d2 = %s, d3 = %s\n",
		       lockstr[lock],
		       permission[d0],
		       permission[d1],
		       permission[d2],
	...
	lock = (reg_value >> 31) & 0x1;
	d0 = ((reg_value>>16) & 0x7);
	d1 = ((reg_value>>16) >> 3) & 0x7;
	d2 = ((reg_value>>16) >> 6) & 0x7;
	d3 = ((reg_value>>16) >> 9) & 0x7;
	ptr += sprintf(ptr, "Region 1 (%s) --> d0 = %s, d1 = %s, d2 = %s, d3 = %s\n",
		       lockstr[lock],
		       permission[d0],
		       permission[d1],
		       permission[d2],
	...
	d2 = (reg_value >> 6) & 0x7;
	d3 = (reg_value >> 9) & 0x7;
	ptr += sprintf(ptr, "Region 2 (%s) --> d0 = %s, d1 = %s, d2 = %s, d3 = %s\n",
		       lockstr[lock],
		       permission[d0],
		       permission[d1],
		       permission[d2],
	...
	d2 = ((reg_value>>16) >> 6) & 0x7;
	d3 = ((reg_value>>16) >> 9) & 0x7;
	ptr += sprintf(ptr, "Region 3 (%s) --> d0 = %s, d1 = %s, d2 = %s, d3 = %s\n",
		       lockstr[lock],
		       permission[d0],
		       permission[d1],
		       permission[d2],
	...
	d2 = (reg_value >> 6) & 0x7;
	d3 = (reg_value >> 9) & 0x7;
	ptr += sprintf(ptr, "Region 4 (%s) --> d0 = %s, d1 = %s, d2 = %s, d3 = %s\n",
		       lockstr[lock],
		       permission[d0],
		       permission[d1],
		       permission[d2],
	...
	d2 = ((reg_value>>16) >> 6) & 0x7;
	d3 = ((reg_value>>16) >> 9) & 0x7;
	ptr += sprintf(ptr, "Region 5 (%s) --> d0 = %s, d1 = %s, d2 = %s, d3 = %s\n",
		       lockstr[lock],
		       permission[d0],
		       permission[d1],
		       permission[d2],
	...
	d2 = (reg_value >> 6) & 0x7;
	d3 = (reg_value >> 9) & 0x7;
	ptr += sprintf(ptr, "Region 6 (%s) --> d0 = %s, d1 = %s, d2 = %s, d3 = %s\n",
		       lockstr[lock],
		       permission[d0],
		       permission[d1],
		       permission[d2],
	...
	d2 = ((reg_value>>16) >> 6) & 0x7;
	d3 = ((reg_value>>16) >> 9) & 0x7;
	ptr += sprintf(ptr, "Region 7 (%s) --> d0 = %s, d1 = %s, d2 = %s, d3 = %s\n",
		       lockstr[lock],
		       permission[d0],
		       permission[d1],
		       permission[d2],
