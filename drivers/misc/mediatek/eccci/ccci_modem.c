...
/* for DFD */
{SMEM_USER_RAW_DFD,		1*1024*1024,	256*1024,	0, },
/* for SIB */
{SMEM_USER_RAW_LWA,		(1*1024+256)*1024,	0*1024*1024,	0, },
{SMEM_USER_RAW_MD_CONSYS,	(1*1024+256)*1024,	0*1024*1024,	0, },
{SMEM_USER_RAW_PHY_CAP,	(1*1024+256)*1024, 0*1024*1024, SMF_NCLR_FIRST, },
...
void ccci_md_config(struct ccci_modem *md)
{
	...
	md->mem_layout.md_bank0.base_ap_view_vir =
		ccci_map_phy_addr(md->mem_layout.md_bank0.base_ap_view_phy,
				MD_IMG_DUMP_SIZE);
	/* Share memory */
	/*
