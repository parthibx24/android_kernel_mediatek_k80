...
static const struct mtk_pinctrl_devdata mt6570_pinctrl_data = {
	.pins = mtk_pins_mt6570,
	.npins = ARRAY_SIZE(mtk_pins_mt6570),
	.grp_desc = NULL,
	.n_grp_cls = 0,
	.pin_drv_grp = NULL,
	.n_pin_drv_grps = 0,
...
static int mt6570_pinctrl_probe(struct platform_device *pdev)
{
	pr_warn("mt6570 pinctrl probe\n");
	return mtk_pctrl_init(pdev, &mt6570_pinctrl_data, NULL);
}

static struct of_device_id mt6570_pctrl_match[] = {
	{
		.compatible = "mediatek,mt6570-pinctrl",
	}, {
	}
};
MODULE_DEVICE_TABLE(of, mt6570_pctrl_match);

static struct platform_driver mtk_pinctrl_driver = {
	.probe = mt6570_pinctrl_probe,
	.driver = {
		.name = "mediatek-mt6570-pinctrl",
		.owner = THIS_MODULE,
		.of_match_table = mt6570_pctrl_match,
	},
};
