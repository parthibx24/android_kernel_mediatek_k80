...
#define sdr_read8(reg)        __raw_readb((const void __iomem *)reg)
#define sdr_read16(reg)       __raw_readw((const void __iomem *)reg)
#define sdr_read32(reg)       __raw_readl((const void __iomem *)reg)
...
extern void __iomem *msdc_io_cfg_top_base;
extern void __iomem *msdc_io_cfg_bottom_base;
extern void __iomem *msdc_io_cfg_right_base;
