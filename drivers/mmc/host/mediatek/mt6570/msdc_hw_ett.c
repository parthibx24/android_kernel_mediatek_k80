...
struct msdc_ett_settings msdc0_ett_hs200_settings_for_sandisk[] = {
	...
	{0xb0, (0x1f << 10), 0x0},	/*PATCH_BIT0[MSDC_PB0_CKGEN_MSDC_DLY_SEL]*/

	/* command & resp ett settings */
	{0xb4, (0x7 << 3), 0x1},	/*PATCH_BIT1[MSDC_PB1_CMD_RSP_TA_CNTR]*/
	{0x4, (0x1 << 1), 0x1},	/*MSDC_IOCON[MSDC_IOCON_RSPL]*/
	{0xf0, (0x1f << 16), 0x0},	/*PAD_TUNE0[MSDC_PAD_TUNE_CMDRDLY]*/
	{0xf0, (0x1f << 22), 0x0},	/*PAD_TUNE0[MSDC_PAD_TUNE_CMDRRDLY]*/

	/* write ett settings */
	{0xb4, (0x7 << 0), 0x1},	/*PATCH_BIT1[MSDC_PB1_WRDAT_CRCS_TA_CNTR]*/
	{0xf0, (0x1f << 0), 0x0},	/*PAD_TUNE0[MSDC_PAD_TUNE_DATWRDLY]*/
	{0x4, (0x1 << 8), 0x1},	/*MSDC_IOCON[MSDC_IOCON_W_D_SMPL]*/
	{0xf8, (0x1f << 24), 0x0},	/*DAT_RD_DLY0[MSDC_DAT_RDDLY0_D0]*/

	/* read ett settings */
	{0xf0, (0x1f << 8), 0x0},	/*PAD_TUNE[MSDC_PAD_TUNE_DATRRDLY]*/
	{0x4, (0x1 << 2), 0x0},	/*MSDC_IOCON[MSDC_IOCON_R_D_SMPL]*/
};
...
#endif
#endif /* MT6570 MSDC_SUPPORT_SANDISK_COMBO_ETT */
...
#endif
#endif /* MT6570 MSDC_SUPPORT_SAMSUNG_COMBO_ETT */
