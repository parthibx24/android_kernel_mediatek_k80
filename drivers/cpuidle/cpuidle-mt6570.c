...
static struct cpuidle_driver mt6570_cpuidle_driver = {
	.name             = "mt6570_cpuidle",
	.owner            = THIS_MODULE,
	.states[0] = {
...
static const struct of_device_id mt6570_idle_state_match[] __initconst = {
 ...
 */
int __init mt6570_cpuidle_init(void)
{
	int cpu, ret;
	struct cpuidle_driver *drv = &mt6570_cpuidle_driver;
...
int __init mt6570_cpuidle_init(void)
{
	return cpuidle_register(&mt6570_cpuidle_driver, NULL);
}
#endif

device_initcall(mt6570_cpuidle_init);
