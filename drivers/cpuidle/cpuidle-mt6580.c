...
static struct cpuidle_driver mt6580_cpuidle_driver = {
	.name             = "mt6580_cpuidle",
	.owner            = THIS_MODULE,
	.states[0] = {
...
static const struct of_device_id mt6580_idle_state_match[] __initconst = {
 ...
 */
int __init mt6580_cpuidle_init(void)
{
	int cpu, ret;
	struct cpuidle_driver *drv = &mt6580_cpuidle_driver;
...
int __init mt6580_cpuidle_init(void)
{
	return cpuidle_register(&mt6580_cpuidle_driver, NULL);
}
#endif

device_initcall(mt6580_cpuidle_init);
