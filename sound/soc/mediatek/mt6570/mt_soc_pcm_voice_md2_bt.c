...
static int mtk_voice_md2_bt_close(struct snd_pcm_substream *substream)
{
	...
	/* SetConnection(Soc_Aud_InterCon_DisConnect, Soc_Aud_InterConnectionInput_I22,
		Soc_Aud_InterConnectionOutput_O02); */
...
static int mtk_voice_md2_bt_prepare(struct snd_pcm_substream *substream)
{
	...
	SetConnection(Soc_Aud_InterCon_Connection, Soc_Aud_InterConnectionInput_I02,
		      Soc_Aud_InterConnectionOutput_O08);
	SetConnection(Soc_Aud_InterCon_Connection, Soc_Aud_InterConnectionInput_I09,
		      Soc_Aud_InterConnectionOutput_O02);
	/* SetConnection(Soc_Aud_InterCon_Connection, Soc_Aud_InterConnectionInput_I22,
		Soc_Aud_InterConnectionOutput_O08); */
	...
	SetDaiBtEnable(true);
	voice_md2_btPcm.mPcmModeWidebandSel = (runtimeStream->rate == 8000) ?
