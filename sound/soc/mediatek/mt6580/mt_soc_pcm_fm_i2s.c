...
static const struct snd_kcontrol_new Audio_snd_fm_i2s_controls[] = {
	SOC_SINGLE_EXT("Audio FM I2S Volume", SND_SOC_NOPM, 0, 0x80000, 0, Audio_fm_i2s_Volume_Get,
...
static int mtk_pcm_fm_i2s_close(struct snd_pcm_substream *substream)
{
	...
	SetConnection(Soc_Aud_InterCon_DisConnect, Soc_Aud_InterConnectionInput_I12,
		      Soc_Aud_InterConnectionOutput_O03);
	SetConnection(Soc_Aud_InterCon_DisConnect, Soc_Aud_InterConnectionInput_I13,
...
static int mtk_pcm_fm_i2s_prepare(struct snd_pcm_substream *substream)
{
	...
	if (mPrepareDone == false) {
		...
		SetConnection(Soc_Aud_InterCon_Connection, Soc_Aud_InterConnectionInput_I01,
			      Soc_Aud_InterConnectionOutput_O16);
		SetConnection(Soc_Aud_InterCon_Connection, Soc_Aud_InterConnectionInput_I12,
			      Soc_Aud_InterConnectionOutput_O03);
		SetConnection(Soc_Aud_InterCon_Connection, Soc_Aud_InterConnectionInput_I13,
			      Soc_Aud_InterConnectionOutput_O04);

		/* Set HW_GAIN */
		pr_warn("%s Soc_Aud_Hw_Digital_Gain_HW_DIGITAL_GAIN2\n", __func__);
...
static struct page *mtk_fm_i2s_pcm_page(struct snd_pcm_substream *substream, unsigned long offset)
{
	pr_warn("%s\n", __func__);
